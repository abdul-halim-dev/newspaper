...
const SpecialNewsCard = () => {
  return (
    <Link to="/" className=" w-full sm:w-[48%] md:w-[31%] lg:w-[32%] flex items-center justify-center relative ">
         ...
         <div className="w-full bg-black/60 left-0 bottom-0 absolute p-2 text-white text-lg font-semibold">
        <h3> কেন সঞ্জয় এর বায়োপিক প্রত্যাখ্যান করেছেন আমির খান </h3>
    </div>
