...
const Hero_section = () => {
  return (
    <section className=" w-full h-full flex lg:flex-row flex-col items-center justify-center gap-2 py-2"> 
...
<div className=" w-full sm:w-[50%] h-full  flex gap-2 items-center justify-center flex-col ">
    <div className="w-full flex items-center justify-center ">
        <button className=" w-full border-0 bg-[#f31527] text-white py-[8px]  text-lg "> Last Update</button>
        <button className=" w-full border-0 bg-[#4f4543] text-white py-[8px]  text-lg ">  Popular Post </button>
    </div>
...
<div className="w-full sm:w-[50%] flex items-start justify-center flex-col gap-2 ">
    

<div className="w-full flex items-center justify-center   ">
        <button className=" w-full border-0 bg-[#f31527] text-white py-[8px]  text-lg "> রাজনীতি  </button>      
</div>
...
<div className="w-full flex flex-col items-start justify-center gap-2">
   ...
   <h3 className="text-lg font-semibold text-black">ছোট ভাইয়ের হাতে বড়ো ভাই খুন </h3>
